...
O sistema SHALL exibir na página `/ferramentas` uma seção "Credenciais globais" com tabela CRUD, reveal e log de auditoria, reutilizando o mesmo padrão visual e de segurança da página de credenciais por persona.
