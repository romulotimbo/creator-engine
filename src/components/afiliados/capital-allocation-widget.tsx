  ...
  return (
    ...
    >
      <Surface style={{ padding: "var(--space-sm) var(--space-md)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--faint)", fontSize: 12, marginBottom: 4 }}>
          <Target size={16} />
          <span>Ofertas no Radar</span>
        </div>
        <p style={{ fontSize: 22, fontWeight: 700, color: "var(--foreground)", margin: 0 }}>
          {totalOfertas} <span style={{ fontSize: 12, fontWeight: 400, color: "var(--muted)" }}>({ofertasEmAnalise} em análise)</span>
        </p>
      </Surface>
      ...
      <Surface style={{ padding: "var(--space-sm) var(--space-md)" }}>
        ...
        <p style={{ fontSize: 22, fontWeight: 700, color: "var(--foreground)", margin: 0 }}>
          {scoreMedio.toFixed(1)} <span style={{ fontSize: 12, color: "var(--muted)" }}>/ 100</span>
        </p>
      </Surface>
      ...
      <Surface style={{ padding: "var(--space-sm) var(--space-md)" }}>
        ...
        <p style={{ fontSize: 22, fontWeight: 700, color: ofertasIncompletas > 0 ? "var(--warning)" : "var(--foreground)", margin: 0 }}>
          {ofertasIncompletas} <span style={{ fontSize: 12, color: "var(--muted)" }}>ofertas parciais</span>
        </p>
      </Surface>
    </div>
  )
