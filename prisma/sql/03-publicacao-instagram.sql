...
--   psql -U romulo_db_user -d personal_db -f prisma/sql/03-publicacao-instagram.sql
--
-- Em dev, `prisma db push` já cria estes objetos.
-- (Cópia idêntica a 08-publicacao-instagram.sql — nome legado da change OpenSpec.)
